...
async function loadPokemon(id){
    try{
        ...
        const abolitiesWrapper = document.querySelector(".pokemon-detail-wrap .pokemon-detail.move");
        abolitiesWrapper = "";
        ...
        if (currentPokemonId === id){
            ...
            const[leftArrow, rightArrow] = ["#leftArrow", "#rightArrow"].map((Selection) => document.querySelector(sel));
...
function capitalizeFirstLetter(string){
    return string.charAt(0).toUpperCase() + string(1).toLowerCase();
}
